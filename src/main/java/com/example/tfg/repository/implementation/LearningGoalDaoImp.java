...
@Repository
public class LearningGoalDaoImp implements LearningGoalDao {

	protected EntityManager em;

	protected static final Logger logger = LoggerFactory
			.getLogger(LearningGoalDaoImp.class);
...
//				+ "AND l NOT IN ?2");
	...
	public Collection<LearningGoal> getLearningGoalsFromActivity(
			Activity activity) {
		Query query1 = em.createQuery("SELECT l FROM Activity a INNER JOIN a.learningGoalStatus s "
