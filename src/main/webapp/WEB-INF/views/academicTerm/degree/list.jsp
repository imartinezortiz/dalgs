		...
		<c:forEach items="${model.academicTerms}" var="academicTerm">
			...
			<!-- <td><c:out value="${activity.name}" /></td>
				...
				-->
  				...
  				<td>
  					<a href="<c:url value='/academicTerm/${academicTerm.term}/degree/${academicTerm.degree.id}/view.htm'/>" class="btn btn-warning 2">View</a>
  					<a href="<c:url value='/academicTerm/${academicTerm.term}/degree/${academicTerm.degree.id}/delete.htm'/>" class="btn btn-danger">Delete</a>
  				</td>
