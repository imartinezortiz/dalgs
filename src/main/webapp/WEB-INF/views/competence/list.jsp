...
<div class="table-responsive list">
    <div class="panel-heading list">
        <h4>Competences</h4>
        <a  class="btn list-btn btn-warning2" href="<c:url value='/competence/add.htm'/>"> Add </a>
    </div>
		...
		<c:forEach items="${model.competences}" var="competence">
			...
			<tr align="center">
				...
				<td><c:out value="${competence.degree.name}" /></td>
  				...
  				<td>
  					<a href="<c:url value='view/${competence.id}.htm'/>" class="btn btn-warning 2">View</a>
  					<a href="<c:url value='delete/${competence.id}.htm'/>" class="btn btn-danger">Delete</a>
  				</td>
